  ...
  module Api
    module Campaign
      ...
      def trigger_custom_event(custom_event, recipients)
        raise ParameterException, Responsys::Helpers.get_message("api.campaign.incorrect_recipients_type") unless recipients.is_a? Array
        raise ParameterException, Responsys::Helpers.get_message("api.object.custom_event.incorrect_event_object") unless custom_event.is_a? Responsys::Api::Object::CustomEvent
