module Responsys
  class Member
    ...
    def retrieve_profile_extension(profile_extension, fields)
      ...
      return Responsys::Helpers.build_custom_error_response("member.record_not_found") unless present_in_profile?(profile_extension)
    ...
    def update(list, data)
      return Responsys::Helpers.build_custom_error_response("member.record_not_found") unless present_in_list?(list)
